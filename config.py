...
class Config():  #Por padrão, o nome das classes precisam estar em Pascal Case (Primeira letra maiúscula)
    SQLALCHEMY_DATABASE_URI = environ.get('URL_DATABASE_PROD', environ.get('URL_DATABASE_DEV'))  #Puxa a variável de ambiente e utiliza para a conexão do ORM ao banco de dados
